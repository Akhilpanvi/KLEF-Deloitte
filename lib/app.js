...
td{padding:11px 14px;border-bottom:1px solid var(--border);vertical-align:top;white-space:nowrap}
...
.issue{font-size:12px;color:var(--bad);margin-top:3px;max-width:290px;white-space:normal}
...
/* author display beats the UA stylesheet, so [hidden] must be restated */
